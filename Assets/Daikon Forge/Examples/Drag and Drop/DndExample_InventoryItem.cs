...
public class DndExample_InventoryItem : MonoBehaviour
{
	...
	private SpellChoices spellChoices;

	void Start()
	{
		spellChoices = GameObject.Find ("SpellChoices").GetComponent<SpellChoices>();
	}
	...
	private void Refresh()
	{
		...
		_label.Text = ( this.Count > 1 ) ? this.Count.ToString() : "";
		...
		{
			case "Empty1":
				spellChoices.offSpell1 = ItemName;
			break;

			case "Empty2":
				spellChoices.offSpell2 = ItemName;
			break;

			case "Empty3":
				spellChoices.offSpell3 = ItemName;
			break;

			case "Empty4":
				spellChoices.defSpell = ItemName;
			break;

			case "Empty5":
				spellChoices.mobSpell = ItemName;
			break;
		}
	}
